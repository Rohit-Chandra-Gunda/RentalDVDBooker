...
type Booking struct {
	...
	BookingId uint64 `protobuf:"varint,3,opt,name=bookingId,proto3" json:"bookingId,omitempty"`
}
...
func (x *Booking) GetDvdId() uint64 {
	if x != nil {
		return x.DvdId
	}
	return 0
...
func (x *Booking) GetBookingId() uint64 {
	if x != nil {
		return x.BookingId
	}
	return 0
...
var file_booking_proto_rawDesc = []byte{
	...
	0x0a, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x66, 0x73, 0x22, 0x55, 0x0a, 0x07, 0x42,
	0x6f, 0x6f, 0x6b, 0x69, 0x6e, 0x67, 0x12, 0x16, 0x0a, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x14,
	0x0a, 0x05, 0x64, 0x76, 0x64, 0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x64,
	0x76, 0x64, 0x49, 0x64, 0x12, 0x1c, 0x0a, 0x09, 0x62, 0x6f, 0x6f, 0x6b, 0x69, 0x6e, 0x67, 0x49,
	0x64, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x62, 0x6f, 0x6f, 0x6b, 0x69, 0x6e, 0x67,
	0x49, 0x64, 0x42, 0x0f, 0x5a, 0x0d, 0x2e, 0x2f, 0x3b, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75,
...
var file_booking_proto_goTypes = []interface{}{
	(*Booking)(nil), // 0: protobuffs.Booking
}
